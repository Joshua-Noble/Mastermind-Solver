# Author: Joshua Noble
# This script will attempt to solve the game Mastermind in the fewest possible moves, with only the given information
# The script assumes we are playing the (4,6) version of Mastermind (4 pegs, 6 colours)
# Colours are replaced with integers (1-6) for simplicity
